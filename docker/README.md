...
- `deploy/docker-compose.yml` wires the full local stack: `postgres`, `redis`, `migrator`, `orchestrator`, `tool-broker`, `tool-http`, `tool-webfetch`, `tool-browser`, `tool-browser-local`, `tool-doctor`, and `web`
