...
- `restart-helper/` provides a narrow control-plane API for restarting allowlisted Docker Compose services without giving the orchestrator broad Docker access.
